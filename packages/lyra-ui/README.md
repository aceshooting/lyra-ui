...
[Web Awesome](https://webawesome.com/), with 286 custom elements, native custom-element APIs,
...
`all.js` registers 270 tags — every component **except** the 16 inventory-designated
...
upgrade in one line, not because pulling 270 elements into a bundle to render four of them is a good
idea.
...
The catalog below lists all 286 tags in the current Custom Elements Manifest, grouped by
