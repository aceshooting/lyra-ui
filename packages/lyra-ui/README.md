...
`all.js` registers 269 tags — every component **except** the 16 inventory-designated
...
upgrade in one line, not because pulling 269 elements into a bundle to render four of them is a good
idea.
