...
import type { LyraToastEventMap, ToastOverflowDetail } from '../src/lyra.js';

const overflowDetail: ToastOverflowDetail = { count: 3 };
...
const invalidDetail: ToastOverflowDetail = { count: '3' };
