...
- **Import** `import '@aceshooting/lyra-ui/components/lr-app-rail-group.js';` (stable tag alias; registers the tag)
...
- **Documented with** `lr-app-rail`, `lr-app-rail-item` (same section below)
