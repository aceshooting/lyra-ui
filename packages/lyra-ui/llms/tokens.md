...
| `--lr-terminal-color-black` | `--lr-theme-terminal-color-black` | `#4d4d4d` |
...
| `--lr-terminal-color-white` | `--lr-theme-terminal-color-white` | `#4d4d4d` |
| `--lr-terminal-color-bright-black` | `--lr-theme-terminal-color-bright-black` | `#636363` |
...
| `--lr-terminal-color-bright-white` | `--lr-theme-terminal-color-bright-white` | `#636363` |
