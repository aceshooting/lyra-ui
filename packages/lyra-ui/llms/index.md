...
- `lr-usage-badge` · lr-usage-badge.js · `stable` since `4.0.0` — a compact, static resource strip for one message or run: tokens in/out, cost, latency, with a hover or keyboard-focus tooltip breakdown.
...
- `lr-entity-chip` · lr-entity-chip.js · `stable` since `4.0.0` — an inline `@entity` mention for agent prose: flow content, keyboard-focusable, with a hover or keyboard-focus preview popover (the focuse...
