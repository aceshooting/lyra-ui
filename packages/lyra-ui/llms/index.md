...
- `lr-email-viewer` · viewers/email-viewer/email-viewer.js — Parses `.eml` messages with the optional `postal-mime` peer and renders their HTML body only after DOMPurify sanitization and inside a pa...
