...
const meta: Meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          "Experimental date-picker surface, including range constraints, calendar views, custom day content, and week numbers.",
      },
    },
  },
};
...
export const ScopedStateTheme: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Day and selection-view states use independent component hooks while retaining the shared semantic tokens as defaults.",
      },
    },
  },
  render: () => html`
    <div
      style="display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:var(--lr-space-l)"
    >
      <lr-date-picker
        value="2026-07-15"
        today="2026-07-10"
