...
export const styles = css`
  ...
  [part='base'] { display: inline-flex; align-items: center; gap: var(--lr-space-xs); min-block-size: var(--lr-icon-button-size); }
  ...
  :host(:not([readonly]):not([disabled])) [part='base']:hover [part='star'] { color: var(--lr-color-border-strong); }
