...
export const styles = css`
  ...
  :host([size='l']) { --lr-rating-size: var(--lr-font-size-2xl); }
  :host([size='xl']) { --lr-rating-size: var(--lr-font-size-3xl); }
  ...
  [part='star-fill'] { position: absolute; inset-block-start: 0; inset-inline-start: 0; block-size: 100%; overflow: hidden; white-space: nowrap; color: var(--lr-rating-fill, var(--lr-color-warning)); }
