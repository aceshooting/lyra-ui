...
export const styles = css`
  ...
  [part='base'] { display: grid; grid-template-columns: auto minmax(0, 1fr) auto; align-items: start; max-inline-size: 100%; box-sizing: border-box; gap: var(--lr-space-s); padding: var(--lr-space-m); border: var(--lr-border-width-thin) solid var(--lr-callout-border, var(--lr-color-border)); border-radius: var(--lr-radius-xs); background: var(--lr-callout-background, var(--lr-color-surface)); color: var(--lr-callout-color, var(--lr-color-text)); }
