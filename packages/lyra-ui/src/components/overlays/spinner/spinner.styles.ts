...
export const styles = css`
  ...
  [part~='base'] { display: inline-flex; align-items: center; justify-content: center; max-inline-size: 100%; }
  ...
  :host([label-placement='after']) [part='label'] { display: inline-flex; align-items: center; min-inline-size: 0; max-inline-size: 100%; overflow-wrap: anywhere; margin-inline-start: var(--lr-space-2xs); color: var(--lr-color-text); font-size: var(--lr-font-size-sm); }
