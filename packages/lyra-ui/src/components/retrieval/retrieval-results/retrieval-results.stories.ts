...
const meta: Meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'A ranked retrieval surface that canonicalizes chunk identity before every derived path and politely announces later settled zero-result transitions without replaying initial or reconnect content.',
      },
    },
  },
};
