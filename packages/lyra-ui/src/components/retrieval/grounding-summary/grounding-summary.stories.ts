...
const meta: Meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'A grounding scorecard that canonicalizes direct citations and nested assessment claims independently by nonblank id before composition, counts, rendering, and events.',
      },
    },
  },
};
