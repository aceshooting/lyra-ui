...
const meta: Meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'A grounded answer surface that canonicalizes citations, sources, and nested assessment claims independently by nonblank id before composition, counts, rendering, lookup, and actions.',
      },
    },
  },
};
