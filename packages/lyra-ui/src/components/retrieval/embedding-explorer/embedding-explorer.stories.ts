...
const meta: Meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'An accessible projection viewer that omits non-finite, blank-id, and later duplicate points before roving focus, selectedPointId state, rendering, and point events. Authored host naming governs the plot, and optional cluster membership is conveyed by both option descriptions and a visible text legend instead of color alone.',
      },
    },
  },
};
