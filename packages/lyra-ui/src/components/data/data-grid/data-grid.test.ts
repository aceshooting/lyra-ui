...
async function dataGrid<Row = Person>(
...
function header<Row>(element: LyraDataGrid<Row>, id: string): HTMLElement {
...
function dataCells<Row>(element: LyraDataGrid<Row>): HTMLElement[] {
  return [
