...
/** Re-exported under a component-scoped name -- what `<lyra-markdown>`'s `math` option needs from
...
/**
 * Loads the optional peer dependency `katex`, used by `<lyra-markdown>`'s `math` property to
