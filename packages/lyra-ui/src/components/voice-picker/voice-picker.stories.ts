...
export const Default: Story = {
  render: () => html`<lyra-voice-picker provider="elevenlabs" label="Voice" .catalog=${catalog}></lyra-voice-picker>`,
};
...
export const AllowCustom: Story = {
  render: () => html`
    <lyra-voice-picker provider="elevenlabs" label="Voice" .catalog=${catalog} allow-custom></lyra-voice-picker>
  `,
};
...
export const FreeTextNoCatalog: Story = {
  render: () => html`<lyra-voice-picker label="Voice" placeholder="Type a voice id…"></lyra-voice-picker>`,
};

/** `preview="false"` (via a property binding) omits both the standalone preview toggle and the
 *  per-row preview icons entirely. */
export const NoPreview: Story = {
  render: () => html`<lyra-voice-picker label="Voice" .catalog=${catalog} .preview=${false}></lyra-voice-picker>`,
};
...
export const Narrow320: Story = {
  render: () => html`
    <div style="max-inline-size: 320px; border: 1px dashed var(--lyra-color-border); padding: 8px;">
      <lyra-voice-picker label="Voice" .catalog=${catalog}></lyra-voice-picker>
    </div>
  `,
};
