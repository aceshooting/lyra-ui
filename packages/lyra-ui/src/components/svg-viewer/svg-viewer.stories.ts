...
const source = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 160 80"><rect width="160" height="80" rx="12" fill="#0969da"/><circle cx="45" cy="40" r="20" fill="#fff"/><path d="M85 25h45v10H85zm0 20h30v10H85z" fill="#fff"/></svg>';
