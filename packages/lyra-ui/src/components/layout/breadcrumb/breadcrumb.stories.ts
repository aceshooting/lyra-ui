...
const meta: Meta = {
  ...
  component: 'lr-breadcrumb',
  tags: ['autodocs'],
  parameters: {
    docs: {
      description: {
        component:
          '`lr-breadcrumb-item.target` uses the domain-specific `LyraBreadcrumbItemTarget` type for its four reserved native browsing-context targets.',
      },
    },
  },
};
