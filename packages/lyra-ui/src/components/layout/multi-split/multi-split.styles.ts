...
export const styles = css`
  :host {
    ...
    --lr-multi-split-overlay-color: var(--lr-color-overlay);
    ...
    --lr-multi-split-divider-target-size: max(
  ...
  [part='divider'] {
    position: relative;
    flex: 0 0 auto;
    inline-size: var(--lr-multi-split-divider-target-size);
    min-block-size: min(100%, var(--lr-multi-split-divider-target-size));
    max-block-size: 100%;
  ...
  :host(:where([orientation='vertical'])) [part='divider'] {
    inline-size: 100%;
    min-inline-size: min(100%, var(--lr-multi-split-divider-target-size));
    max-inline-size: 100%;
    min-block-size: 0;
    block-size: var(--lr-multi-split-divider-target-size);
    cursor: row-resize;
  }
  ...
  [part='backdrop'] {
    ...
    background: var(--lr-multi-split-overlay-color);
  }
