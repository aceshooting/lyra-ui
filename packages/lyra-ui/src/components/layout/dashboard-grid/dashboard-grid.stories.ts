...
const layout: LyraDashboardCell[] = [
  ...
  },
  {
    ...
    widget: {
      type: "markdown",
      props: { content: "Nothing needs attention right now." },
    },
  },
];
...
export const Empty: Story = {
  render: () =>
    html`<lr-dashboard-grid style="width:100%"></lr-dashboard-grid>`,
};
...
export const NarrowAllocation: Story = {
  ...
  render: () => html`
    <div
      style="inline-size:320px; max-inline-size:100%; border:1px dashed var(--lr-color-border);"
    >
      <lr-dashboard-grid
        style="width:100%"
        .layout=${layout}
