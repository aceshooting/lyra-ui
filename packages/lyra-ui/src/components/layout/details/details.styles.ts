...
export const styles = css`
  ...
  [part='base'] { border-block-end: var(--lr-border-width-thin) solid var(--lr-color-border); min-inline-size: 0; max-inline-size: 100%; }
  [part='summary'] { display: flex; align-items: center; justify-content: space-between; gap: var(--lr-space-s); padding-block: var(--lr-space-m); color: var(--lr-color-text); cursor: pointer; font-weight: var(--lr-font-weight-semibold); list-style: none; min-inline-size: 0; max-inline-size: 100%; overflow: clip; overflow-wrap: anywhere; }
  ...
  [part='content'] { padding-block-end: var(--lr-space-m); min-inline-size: 0; max-inline-size: 100%; overflow-wrap: anywhere; }
