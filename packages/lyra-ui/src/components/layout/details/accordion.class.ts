 ...
 * @cssprop [--lr-accordion-outlined-border-color=var(--lr-color-border-subtle)] - Outlined border color.
 ...
 *   group background.
 * @cssprop [--lr-accordion-filled-outlined-border-color=var(--lr-color-border-subtle)] - Filled-outlined
 *   border color.
 * @status stable
 * @since 4.0.0
 */
