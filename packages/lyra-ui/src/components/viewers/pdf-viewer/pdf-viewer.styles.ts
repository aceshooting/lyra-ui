...
export const styles = css`
  ...
  [part='toolbar'] button:hover { background: var(--lr-pdf-viewer-toolbar-button-hover-bg, var(--lr-color-surface)); }
  [part='toolbar'] button:active { background: color-mix(in oklab, var(--lr-pdf-viewer-toolbar-button-hover-bg, var(--lr-color-surface)), var(--lr-color-mix-partner) var(--lr-color-mix-active)); }
