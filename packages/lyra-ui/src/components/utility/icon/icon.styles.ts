...
export const styles = css`
  ...
  :host(:where([rotate], [flip])) {
    transform: rotate(var(--lr-icon-rotate, 0deg))
      scale(
        var(--lr-icon-flip-x, var(--_lr-icon-flip-x, 1)),
        var(--lr-icon-flip-y, var(--_lr-icon-flip-y, 1))
      );
  }
  ...
  @keyframes lr-icon-bounce {
    ...
    70% {
      transform: translateY(
          var(--bounce-rebound, calc(var(--lr-size-1em) * -0.1))
        )
        scale(
  ...
  @keyframes lr-icon-float {
    ...
    50% {
      transform: translateX(var(--float-drift, 0))
        ...
        scale(var(--float-stretch-x, 0.96), var(--float-stretch-y, 1.04));
    }
  }
