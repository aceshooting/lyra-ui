import { loadFlagUrl, setFlagUrlResolver, type LyraFlagUrlResolver } from './flag.js';
 ...
 */
export async function registerLyraFlagPeer(): Promise<LyraFlagUrlResolver | null> {
  return peerResolver;
}
