...
export const LiveGutterLocalization: Story = {
  render: () => html`
    <div lang="en">
      ...
      <lr-code-block-core .languages=${{ typescript: tsGrammar }} language="typescript" line-numbers activatable-lines
...
export const RightToLeft: Story = {
  ...
  render: () => html`
    <div dir="rtl" style="inline-size: 400px; max-inline-size: 100%;">
      <lr-code-block-core .languages=${{}} language="c++" filename="./src/main.cpp" max-height="8rem" line-numbers
