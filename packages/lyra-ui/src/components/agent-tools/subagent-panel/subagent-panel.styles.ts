...
export const styles = css`
  ...
  [part~='run-selected'] { border-color: var(--lr-color-brand); }
  ...
  [part='progress'] { grid-column: 1 / -1; block-size: var(--lr-size-0-25rem); border-radius: var(--lr-radius-pill); background: var(--lr-color-border); overflow: hidden; }
  [part='progress'] > span { display: block; block-size: 100%; background: var(--lr-color-brand); }
