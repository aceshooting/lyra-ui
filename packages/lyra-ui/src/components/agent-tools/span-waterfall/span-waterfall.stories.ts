...
const meta: Meta = {
  ...
  tags: ['autodocs'],
  parameters: { docs: { description: { component: 'Span views omit whitespace-only IDs and preserve every nonblank business ID exactly, including surrounding whitespace. The first valid admitted duplicate continues to win. Every interactive span bar retains a 24px target in both axes, even when a very short duration paints more narrowly on the timeline.' } } },
};
export default meta;
type Story = StoryObj;
