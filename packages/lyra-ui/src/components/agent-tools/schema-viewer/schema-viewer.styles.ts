...
export const styles = css`
  ...
  [part~='node-selected'] { border-inline-start-color: var(--lr-color-brand); }
  [part='node-trigger'] {
  ...
  [part='issue'] { padding: var(--lr-space-xs); border-inline-start: var(--lr-border-width-thick) solid var(--lr-color-danger); background: var(--lr-color-danger-quiet); }
  [part='issue'][data-severity='warning'] { border-inline-start-color: var(--lr-color-warning); background: var(--lr-color-warning-quiet); }
