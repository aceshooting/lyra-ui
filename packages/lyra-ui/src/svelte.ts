...
export type LyraConditionBuilderSvelteProps = LyraSvelteElementProps<
...
export type LyraEvalRunSvelteProps = LyraSvelteElementProps<
  LyraEvalRun,
  | 'examples'
  | 'label'
  | 'locale'
...
export type LyraFlowRunStatusSvelteProps = LyraSvelteElementProps<
  LyraFlowRunStatus,
  | 'decorations'
  | 'for'
  | 'frame'
...
export type LyraFunnelSvelteProps = LyraSvelteElementProps<
  LyraFunnel,
  | 'comparison'
  | 'comparisonLabel'
  | 'dropoff'
...
export type LyraGenerationMetricsSvelteProps = LyraSvelteElementProps<
...
export type LyraGeoJsonViewerSvelteProps = LyraSvelteElementProps<
  LyraGeoJsonViewer,
  | 'activeHighlightId'
  | 'anchor'
  | 'highlights'
...
export type LyraJsonSchemaViewerSvelteProps = LyraSvelteElementProps<
...
export type LyraMenubarSvelteProps = LyraSvelteElementProps<
  LyraMenubar,
  | 'frame'
  | 'label'
  | 'locale'
...
export type LyraMenubarItemSvelteProps = LyraSvelteElementProps<
  LyraMenubarItem,
  | 'disabled'
  | 'locale'
  | 'strings',
...
export type LyraMultiSplitSvelteProps = LyraSvelteElementProps<
  LyraMultiSplit,
  | 'collapse'
...
export type LyraSequencePlaybackSvelteProps = LyraSvelteElementProps<
...
export type LyraStreamingTextCoreSvelteProps = LyraSvelteElementProps<
...
export interface LyraElementTagNameMap {
  ...
  'lr-menubar': LyraMenubar;
  'lr-menubar-item': LyraMenubarItem;
