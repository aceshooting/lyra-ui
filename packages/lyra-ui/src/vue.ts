...
export type LyraContextMenuVueProps = LyraVueCustomElement<
  LyraContextMenu,
  | 'disabled'
  | 'label'
  | 'locale'
...
export type LyraMenubarVueProps = LyraVueCustomElement<
  LyraMenubar,
  | 'frame'
  | 'label'
  | 'locale'
...
export type LyraMenubarItemVueProps = LyraVueCustomElement<
  LyraMenubarItem,
  | 'disabled'
  | 'locale'
  | 'strings',
...
export type LyraNavigationMenuVueProps = LyraVueCustomElement<
  LyraNavigationMenu,
  | 'accessibleLabel'
  | 'distance'
  | 'expanded'
...
export type LyraNavigationMenuItemVueProps = LyraVueCustomElement<
...
export type LyraToggleVueProps = LyraVueCustomElement<
  LyraToggle,
  | 'appearance'
  | 'disabled'
  | 'locale'
...
export type LyraToggleGroupVueProps = LyraVueCustomElement<
  LyraToggleGroup,
  | 'appearance'
  | 'disabled'
  | 'label'
...
export type LyraToolCallBlockVueProps = LyraVueCustomElement<
  LyraToolCallBlock,
  | 'args'
  | 'callId'
  | 'durationMs'
