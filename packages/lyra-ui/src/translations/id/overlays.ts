...
//
// The `overlays` slice of the id translation catalog for @aceshooting/lyra-ui: strings owned exclusively by `src/components/overlays/**`.
// A side-effect-only module -- a consumer writes a bare
// `import '@aceshooting/lyra-ui/translations/id/overlays';` and reads nothing from it.
...
const strings: LyraLocaleStrings = {
  ...
  closeWithContext: 'Tutup: {snippet}',
  closeWithTruncatedContext: 'Tutup: {snippet}…',
  toastContentIncomplete: 'Notifikasi dengan konten yang belum lengkap',
  toastOverflow: 'Notifikasi yang tidak ditampilkan: {count}.',
  kbdEscapeVisual: 'Esc',
  ...
  kbdArrowUpWord: 'Panah atas',
  kbdArrowDownWord: 'Panah bawah',
  kbdArrowLeftWord: 'Panah kiri',
  kbdArrowRightWord: 'Panah kanan',
  kbdPlusWord: 'Plus',
  kbdMinusWord: 'Minus',
