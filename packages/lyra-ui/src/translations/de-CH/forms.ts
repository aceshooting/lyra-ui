...
//
// The `forms` slice of the de-CH translation catalog for @aceshooting/lyra-ui: strings owned exclusively by `src/components/forms/**`.
// A side-effect-only module -- a consumer writes a bare
// `import '@aceshooting/lyra-ui/translations/de-CH/forms';` and reads nothing from it.
...
const strings: LyraLocaleStrings = {
  ...
  emojiPickerSearchPlaceholder: 'Emojis suchen…',
