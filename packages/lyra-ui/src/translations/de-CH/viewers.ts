...
//
// The `viewers` slice of the de-CH translation catalog for @aceshooting/lyra-ui: strings owned exclusively by `src/components/viewers/**`.
// A side-effect-only module -- a consumer writes a bare
// `import '@aceshooting/lyra-ui/translations/de-CH/viewers';` and reads nothing from it.
...
const strings: LyraLocaleStrings = {
  ...
  documentPreviewResourceTooLarge: 'Dieses Dokument ist zu gross für eine Vorschau.',
