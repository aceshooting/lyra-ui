// <generated:all-component-registrations>
...
// Curated companion registrations have no custom-element inventory row: each one registers a
// document-viewer renderer rather than a custom element.
...
// Importing `all.js` is the explicit replacement for the pre-8 side effect of importing the root.
// The named surface is shared with the registration-free package root.
export * from './lyra.js';
