...
export const LYRA_EVENT_CANCELABLE: {
  ...
  'lr-bubble-chart': { 'lr-before-datum-visibility-change': true, 'lr-before-legend-visibility-change': true },
  'lr-button': { 'lr-invalid': true },
  'lr-callout': { 'lr-close': true },
  'lr-chart': { 'lr-before-datum-visibility-change': true, 'lr-before-legend-visibility-change': true },
  ...
  'lr-command-palette': { 'lr-close': true, 'lr-open': true },
  ...
  'lr-data-grid': { 'lr-cell-contextmenu': true, 'lr-sort-request': true },
  ...
  'lr-document-library': { 'lr-sort-request': true },
  'lr-doughnut-chart': { 'lr-before-datum-visibility-change': true, 'lr-before-legend-visibility-change': true },
  ...
  'lr-graph-legend': { 'lr-before-visibility-change': true },
  'lr-graph-query-builder': { 'lr-before-query-delete': true, 'lr-before-query-load': true, 'lr-before-query-run': true, 'lr-before-query-save': true, 'lr-invalid': true },
  'lr-histogram': { 'lr-before-datum-visibility-change': true, 'lr-before-legend-visibility-change': true },
  ...
  'lr-pie-chart': { 'lr-before-datum-visibility-change': true, 'lr-before-legend-visibility-change': true },
  'lr-polar-area-chart': { 'lr-before-datum-visibility-change': true, 'lr-before-legend-visibility-change': true },
  ...
  'lr-radar-chart': { 'lr-before-datum-visibility-change': true, 'lr-before-legend-visibility-change': true },
  ...
  'lr-scatter-chart': { 'lr-before-datum-visibility-change': true, 'lr-before-legend-visibility-change': true },
  ...
  'lr-thread-list': { 'lr-group-toggle-request': true },
