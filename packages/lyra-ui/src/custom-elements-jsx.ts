...
import type { LyraMenubarItem } from './components/layout/menubar/menubar-item.class.js';
import type { LyraMenubar, LyraMenubarEventMap } from './components/layout/menubar/menubar.class.js';
...
export type LyraAccordionReactProps = LyraReactElementProps<
  LyraAccordion,
  | 'appearance'
  | 'headingLevel'
  | 'iconPlacement'
...
export type LyraAccordionItemReactProps = LyraReactElementProps<
  LyraAccordionItem,
  | 'appearance'
  | 'disabled'
  | 'expanded'
...
export type LyraActivityFeedReactProps = LyraReactElementProps<
  LyraActivityFeed,
  | 'compact'
  | 'entries'
  | 'expanded'
...
export type LyraAgentEvalDashboardReactProps = LyraReactElementProps<
...
export type LyraAgentRunReactProps = LyraReactElementProps<
  LyraAgentRun,
  | 'compact'
  | 'formatCost'
  | 'frame'
...
export type LyraAgentTraceReactProps = LyraReactElementProps<
  LyraAgentTrace,
  | 'activeSpanId'
  | 'hiddenKinds'
  | 'label'
...
export type LyraAgentWorkspaceReactProps = LyraReactElementProps<
  LyraAgentWorkspace,
  | 'accessibleLabel'
  | 'citations'
  | 'composerMaxRows'
...
export type LyraAlertReactProps = LyraReactElementProps<
  LyraAlert,
  | 'closable'
  | 'countdown'
  | 'duration'
...
export type LyraAnimatedImageReactProps = LyraReactElementProps<
  LyraAnimatedImage,
  | 'accessibleLabel'
  | 'alt'
  | 'locale'
...
export type LyraAnimationReactProps = LyraReactElementProps<
  LyraAnimation,
  | 'currentTime'
  | 'delay'
  | 'direction'
...
export type LyraAppRailReactProps = LyraReactElementProps<
  ...
  | '--lr-app-rail-frame-gap'
  | '--lr-app-rail-frame-radius'
  | '--lr-app-rail-frame-shadow'
...
export type LyraAppRailGroupReactProps = LyraReactElementProps<
  ...
  | '--lr-app-rail-group-active-color'
  | '--lr-app-rail-group-gap'
  | '--lr-app-rail-group-heading-color'
  | '--lr-app-rail-group-heading-font-size'
  | '--lr-app-rail-group-hover-bg'
  | '--lr-app-rail-group-hover-color'
...
export type LyraAppRailItemReactProps = LyraReactElementProps<
  ...
  | '--lr-app-rail-item-icon-size'
  | '--lr-app-rail-item-indent'
  | '--lr-app-rail-item-meta-color'
  | '--lr-app-rail-item-meta-font-size'
  | '--lr-app-rail-item-min-block-size'
  | '--lr-app-rail-item-padding'
...
export type LyraApprovalQueueReactProps = LyraReactElementProps<
  LyraApprovalQueue,
  | 'editable'
  | 'label'
  | 'locale'
...
export type LyraArchiveViewerReactProps = LyraReactElementProps<
  LyraArchiveViewer,
  | 'activeHighlightId'
  | 'anchor'
  | 'highlights'
...
export type LyraArtifactPanelReactProps = LyraReactElementProps<
  LyraArtifactPanel,
  | 'activeVersionId'
  | 'copyText'
  | 'downloadName'
...
export type LyraAttachmentChipReactProps = LyraReactElementProps<
  LyraAttachmentChip,
  | 'attachmentId'
  | 'bytes'
  | 'compact'
...
export type LyraAttachmentTriggerReactProps = LyraReactElementProps<
...
export type LyraAudioVisualizerReactProps = LyraReactElementProps<
  LyraAudioVisualizer,
  | 'barCount'
  | 'gain'
  | 'label'
...
export type LyraAvPlayerReactProps = LyraReactElementProps<
  LyraAvPlayer,
  | 'activeHighlightId'
  | 'anchor'
  | 'cues'
...
export type LyraAvatarReactProps = LyraReactElementProps<
  LyraAvatar,
  | 'image'
  | 'initials'
  | 'label'
...
export type LyraAvatarGroupReactProps = LyraReactElementProps<
  LyraAvatarGroup,
  | 'label'
  | 'locale'
  | 'max'
...
export type LyraBadgeReactProps = LyraReactElementProps<
  LyraBadge,
  | 'appearance'
  | 'attention'
  | 'locale'
...
export type LyraBoxPlotReactProps = LyraReactElementProps<
  LyraBoxPlot,
  | 'beginAtZero'
  | 'datasets'
  | 'dataTableToggle'
...
export type LyraBranchPickerReactProps = LyraReactElementProps<
  LyraBranchPicker,
  | 'count'
  | 'index'
  | 'label'
...
export type LyraBreadcrumbReactProps = LyraReactElementProps<
  LyraBreadcrumb,
  | 'accessibleLabel'
  | 'label'
  | 'locale'
...
export type LyraBreadcrumbItemReactProps = LyraReactElementProps<
  LyraBreadcrumbItem,
  | 'current'
  | 'href'
  | 'locale'
...
export type LyraBrowserFrameReactProps = LyraReactElementProps<
  LyraBrowserFrame,
  | 'controller'
  | 'controls'
  | 'frameSrc'
...
export type LyraButtonReactProps = LyraReactElementProps<
  LyraButton,
  | 'accessibleLabel'
  | 'appearance'
  | 'caret'
  ...
  | '--lr-button-width',
  {
    ...
    'aria-keyshortcuts'?: LyraAttributeValue<string | null>;
...
export type LyraButtonGroupReactProps = LyraReactElementProps<
  LyraButtonGroup,
  | 'label'
  | 'locale'
  | 'orientation'
...
export type LyraCalendarReactProps = LyraReactElementProps<
  LyraCalendar,
  | 'accessibleLabel'
  | 'events'
  | 'firstDayOfWeek'
...
export type LyraCalendarViewerReactProps = LyraReactElementProps<
  LyraCalendarViewer,
  | 'activeHighlightId'
  | 'anchor'
  | 'highlights'
...
export type LyraCalloutReactProps = LyraReactElementProps<
  LyraCallout,
  | 'accessibleLabel'
  | 'announce'
  | 'appearance'
...
export type LyraCardReactProps = LyraReactElementProps<
  LyraCard,
  | 'accessibleLabel'
  | 'actionable'
  | 'appearance'
...
export type LyraCarouselReactProps = LyraReactElementProps<
  LyraCarousel,
  | 'accessibleLabel'
  | 'autoplay'
  | 'autoplayInterval'
...
export type LyraCarouselItemReactProps = LyraReactElementProps<
  LyraCarouselItem,
  | 'locale'
  | 'strings',
  {},
...
export type LyraChatViewportReactProps = LyraReactElementProps<
  LyraChatViewport,
  | 'accessibleLabel'
  | 'bottomThreshold'
  | 'follow'
...
export type LyraCheckboxReactProps = LyraReactElementProps<
  LyraCheckbox,
  | 'checked'
  | 'customError'
  | 'defaultChecked'
...
export type LyraCheckboxGroupReactProps = LyraReactElementProps<
  LyraCheckboxGroup,
  | 'accessibleLabel'
  | 'customError'
  | 'disabled'
...
export type LyraCheckpointReactProps = LyraReactElementProps<
  LyraCheckpoint,
  | 'checkpointId'
  | 'confirmRestore'
  | 'formatTimestamp'
...
export type LyraChunkInspectorReactProps = LyraReactElementProps<
  LyraChunkInspector,
  | 'activeChunkId'
  | 'chunks'
  | 'compact'
...
export type LyraCitationBadgeReactProps = LyraReactElementProps<
  LyraCitationBadge,
  | 'href'
  | 'index'
  | 'label'
...
export type LyraClaimEvidenceReactProps = LyraReactElementProps<
  LyraClaimEvidence,
  | 'citations'
  | 'claims'
  | 'compact'
...
export type LyraCodeBlockReactProps = LyraReactElementProps<
  LyraCodeBlock,
  | 'accessibleLabel'
  | 'activatableLines'
  | 'activeHighlightId'
  ...
  | '--lr-theme-scrollbar-width',
  {
    ...
    'copy-appearance'?: LyraCodeBlock['copyAppearance'];
...
export type LyraCodeBlockCoreReactProps = LyraReactElementProps<
  LyraCodeBlockCore,
  | 'accessibleLabel'
  | 'activatableLines'
  | 'activeHighlightId'
  ...
  | '--lr-theme-scrollbar-width',
  {
    ...
    'copy-appearance'?: LyraCodeBlockCore['copyAppearance'];
...
export type LyraCodeEditorReactProps = LyraReactElementProps<
  LyraCodeEditor,
  | 'accessibleLabel'
  | 'autocapitalize'
  | 'autocomplete'
...
export type LyraColorPickerReactProps = LyraReactElementProps<
  LyraColorPicker,
  | 'accessibleLabel'
  | 'customError'
  | 'defaultValue'
  ...
  | '--swatch-size',
  {
    ...
    'positioning-strategy'?: LyraColorPicker['positioningStrategy'];
...
export type LyraComboboxReactProps = LyraReactElementProps<
  LyraCombobox,
  | 'allowCreate'
  | 'allowCustomValue'
  | 'appearance'
...
export type LyraCommandPaletteReactProps = LyraReactElementProps<
  LyraCommandPalette,
  | 'accessibleLabel'
  | 'commands'
  | 'hotkey'
  ...
  | '--lr-command-palette-search-font-size'
...
export type LyraCommitCardReactProps = LyraReactElementProps<
  LyraCommitCard,
  | 'author'
  | 'compact'
  | 'copyable'
...
export type LyraCommunityCardReactProps = LyraReactElementProps<
  LyraCommunityCard,
  | 'community'
  | 'compact'
  | 'frame'
...
export type LyraComparePanelReactProps = LyraReactElementProps<
  LyraComparePanel,
  | 'allowedVotes'
  | 'disabled'
  | 'itemId'
...
export type LyraConditionBuilderReactProps = LyraReactElementProps<
...
export type LyraConfirmBarReactProps = LyraReactElementProps<
  LyraConfirmBar,
  | 'args'
  | 'autofocus'
  | 'compact'
...
export type LyraContactViewerReactProps = LyraReactElementProps<
  LyraContactViewer,
  | 'activeHighlightId'
  | 'anchor'
  | 'headingLevel'
...
export type LyraContextInspectorReactProps = LyraReactElementProps<
...
export type LyraContextMenuReactProps = LyraReactElementProps<
  LyraContextMenu,
  | 'disabled'
  | 'label'
  | 'locale'
...
export type LyraContextMeterReactProps = LyraReactElementProps<
  LyraContextMeter,
  | 'interactive'
  | 'label'
  | 'legendDisplay'
  ...
  | 'lr-segment-activate',
  | '--lr-context-meter-disabled-opacity'
  | '--lr-context-meter-legend-swatch-size'
  | '--lr-context-meter-segment-color'
  | '--lr-context-meter-segment-seam-color'
  | '--lr-context-meter-selected-arc-stroke'
  | '--lr-context-meter-selected-ring-color'
  | '--lr-context-meter-selected-ring-width'
  | '--lr-context-meter-tone-brand-bg'
  | '--lr-context-meter-tone-danger-bg'
  | '--lr-context-meter-tone-success-bg'
  | '--lr-context-meter-tone-warning-bg'
...
export type LyraConversationItemReactProps = LyraReactElementProps<
...
export type LyraCopyButtonReactProps = LyraReactElementProps<
  LyraCopyButton,
  | 'accessibleLabel'
  | 'copyLabel'
  | 'disabled'
...
export type LyraCsvViewerReactProps = LyraReactElementProps<
  LyraCsvViewer,
  | 'activeHighlightId'
  | 'anchor'
  | 'hasHeaderRow'
...
export type LyraDashboardGridReactProps = LyraReactElementProps<
  LyraDashboardGrid,
  | 'accessibleLabel'
  | 'cellsDraggable'
  | 'cellsResizable'
...
export type LyraDataGridReactProps = LyraReactElementProps<
  LyraDataGrid,
  | 'appearance'
  | 'childRows'
  | 'columnOrder'
...
export type LyraDatasetViewerReactProps = LyraReactElementProps<
  LyraDatasetViewer,
  | 'activeHighlightId'
  | 'anchor'
  | 'highlights'
...
export type LyraDateInputReactProps = LyraReactElementProps<
  LyraDateInput,
  | 'accessibleLabel'
  | 'appearance'
  | 'assumeInteractionOn'
...
export type LyraDatePickerReactProps = LyraReactElementProps<
  LyraDatePicker,
  | 'dayContent'
  | 'disabled'
  | 'disabledDates'
...
export type LyraDetailsReactProps = LyraReactElementProps<
  LyraDetails,
  | 'appearance'
  | 'disabled'
  | 'iconPlacement'
...
export type LyraDialogReactProps = LyraReactElementProps<
  LyraDialog,
  | 'accessibleLabel'
  | 'closable'
  | 'heading'
...
export type LyraDividerReactProps = LyraReactElementProps<
  LyraDivider,
  | 'locale'
  | 'orientation'
  | 'strings'
...
export type LyraDockPanelReactProps = LyraReactElementProps<
  LyraDockPanel,
  | 'collapsed'
  | 'collapsible'
  | 'edge'
...
export type LyraDocumentCompareReactProps = LyraReactElementProps<
  LyraDocumentCompare,
  | 'anchor'
  | 'copyable'
  | 'diffLayout'
...
export type LyraDocumentLibraryReactProps = LyraReactElementProps<
  LyraDocumentLibrary,
  | 'documents'
  | 'error'
  | 'errorDescription'
...
export type LyraDocumentPreviewReactProps = LyraReactElementProps<
  LyraDocumentPreview,
  | 'activeHighlightId'
  | 'alt'
  | 'errorText'
...
export type LyraDocumentViewerReactProps = LyraReactElementProps<
  LyraDocumentViewer,
  | 'alt'
  | 'anchor'
  | 'highlights'
...
export type LyraDocxViewerReactProps = LyraReactElementProps<
  LyraDocxViewer,
  | 'activeHighlightId'
  | 'anchor'
  | 'highlights'
...
export type LyraDrawerReactProps = LyraReactElementProps<
  LyraDrawer,
  | 'accessibleLabel'
  | 'closable'
  | 'contained'
...
export type LyraDrilldownPanelReactProps = LyraReactElementProps<
  LyraDrilldownPanel,
  | 'accessibleLabel'
  | 'activeCategory'
  | 'communityLabel'
...
export type LyraDropZoneReactProps = LyraReactElementProps<
  LyraDropZone,
  | 'accept'
  | 'disabled'
  | 'heldFileCount'
...
export type LyraDropdownReactProps = LyraReactElementProps<
  LyraDropdown,
  | 'accessibleLabel'
  | 'anchor'
  | 'arrow'
  ...
  | '--show-duration',
  {
    ...
    'hide-delay'?: LyraDropdown['hideDelay'];
    'hover-bridge'?: LyraDropdown['hoverBridge'];
...
export type LyraDropdownItemReactProps = LyraReactElementProps<
  LyraDropdownItem,
  | 'checked'
  | 'disabled'
  | 'download'
  ...
  | '--lr-menu-item-gap'
  | '--lr-menu-item-hover-bg'
  | '--lr-menu-item-icon-color'
...
export type LyraEbookViewerReactProps = LyraReactElementProps<
  LyraEbookViewer,
  | 'activeHighlightId'
  | 'anchor'
  | 'highlights'
...
export type LyraEmailViewerReactProps = LyraReactElementProps<
  LyraEmailViewer,
  | 'activeHighlightId'
  | 'anchor'
  | 'foldQuotes'
...
export type LyraEmbeddingExplorerReactProps = LyraReactElementProps<
...
export type LyraEmojiPickerReactProps = LyraReactElementProps<
  LyraEmojiPicker,
  | 'accessibleLabel'
  | 'customError'
  | 'defaultValue'
  ...
  | '--lr-emoji-picker-search-padding-block'
  | '--lr-emoji-picker-search-padding-inline'
...
export type LyraEmptyReactProps = LyraReactElementProps<
  LyraEmpty,
  | 'announce'
  | 'compact'
  | 'description'
...
export type LyraEntityCardReactProps = LyraReactElementProps<
  LyraEntityCard,
  | 'communityLabel'
  | 'compact'
  | 'entity'
...
export type LyraEntityChipReactProps = LyraReactElementProps<
  LyraEntityChip,
  | 'entityId'
  | 'locale'
  | 'strings'
...
export type LyraEntityDossierReactProps = LyraReactElementProps<
  LyraEntityDossier,
  | 'accessibleLabel'
  | 'chunks'
  | 'communityLabel'
...
export type LyraEnvListReactProps = LyraReactElementProps<
  LyraEnvList,
  | 'copyable'
  | 'entries'
  | 'label'
...
export type LyraEvalDatasetReactProps = LyraReactElementProps<
  ...
  | 'lr-import-request'
  | 'lr-sort',
  | '--lr-eval-dataset-search-font-size'
...
export type LyraEvalResultReactProps = LyraReactElementProps<
  LyraEvalResult,
  | 'baselineRunId'
  | 'columns'
  | 'disabled'
...
export type LyraEvalRunReactProps = LyraReactElementProps<
  LyraEvalRun,
  | 'examples'
  | 'label'
  | 'locale'
...
export type LyraFileIconReactProps = LyraReactElementProps<
  LyraFileIcon,
  | 'bytes'
  | 'decorative'
  | 'label'
...
export type LyraFileInputReactProps = LyraReactElementProps<
  LyraFileInput,
  | 'accept'
  | 'acceptedMessage'
  | 'accessibleLabel'
  ...
  | '--lr-file-input-dropzone-border-color'
  | '--lr-file-input-dropzone-fill'
  | '--lr-file-input-dropzone-font-size'
  | '--lr-file-input-dropzone-hover-border-color'
  ...
  | '--lr-form-control-required-offset',
  {
    ...
    'held-total-size'?: LyraFileInput['heldTotalSize'];
...
export type LyraFileTreeReactProps = LyraReactElementProps<
  LyraFileTree,
  | 'label'
  | 'locale'
  | 'nodes'
...
export type LyraFilterBarReactProps = LyraReactElementProps<
  LyraFilterBar,
  ...
  | 'lr-reset'
  | 'lr-validity-change',
  | '--lr-filter-bar-field-basis'
  | '--lr-filter-bar-gap',
  {
    'active-filters-display'?: LyraFilterBar['activeFiltersDisplay'];
  }
>;
...
export type LyraFlowCanvasReactProps = LyraReactElementProps<
  LyraFlowCanvas,
  | 'accessibleLabel'
  | 'connectable'
  | 'decorations'
...
export type LyraFlowControlsReactProps = LyraReactElementProps<
  LyraFlowControls,
  | 'for'
  | 'frame'
  | 'hideLock'
...
export type LyraFlowNodeReactProps = LyraReactElementProps<
  LyraFlowNode,
  | 'compact'
  | 'durationMs'
  | 'flowType'
...
export type LyraFlowRunStatusReactProps = LyraReactElementProps<
  LyraFlowRunStatus,
  | 'decorations'
  | 'for'
  | 'frame'
...
export type LyraFormatBytesReactProps = LyraReactElementProps<
  LyraFormatBytes,
  | 'decimals'
  | 'display'
  | 'locale'
...
export type LyraFormatDateReactProps = LyraReactElementProps<
  LyraFormatDate,
  | 'date'
  | 'dateStyle'
  | 'day'
...
export type LyraFormatNumberReactProps = LyraReactElementProps<
  LyraFormatNumber,
  | 'currency'
  | 'currencyDisplay'
  | 'locale'
...
export type LyraFunnelReactProps = LyraReactElementProps<
  LyraFunnel,
  | 'comparison'
  | 'comparisonLabel'
  | 'dropoff'
...
export type LyraGaugeReactProps = LyraReactElementProps<
  LyraGauge,
  | 'label'
  | 'locale'
  | 'max'
...
export type LyraGenerationMetricsReactProps = LyraReactElementProps<
...
export type LyraGeojsonViewReactProps = LyraReactElementProps<
  LyraGeojsonView,
  | 'activeHighlightId'
  | 'anchor'
  | 'highlights'
...
export type LyraGeoJsonViewerReactProps = LyraReactElementProps<
  LyraGeoJsonViewer,
  | 'activeHighlightId'
  | 'anchor'
  | 'highlights'
...
export type LyraGraphReactProps = LyraReactElementProps<
  LyraGraph,
  | 'accessibleLabel'
  | 'chargeStrength'
  | 'communities'
...
export type LyraGraphLegendReactProps = LyraReactElementProps<
  LyraGraphLegend,
  | 'counts'
  | 'hiddenTypes'
  | 'interactive'
...
export type LyraGroundingSummaryReactProps = LyraReactElementProps<
...
export type LyraHandoffDividerReactProps = LyraReactElementProps<
  LyraHandoffDivider,
  | 'fromAgent'
  | 'label'
  | 'locale'
...
export type LyraHeatmapReactProps = LyraReactElementProps<
  LyraHeatmap,
  | 'accessibleCells'
  | 'annotations'
  | 'bucketCount'
  ...
  | '--lr-heatmap-tooltip-text',
  {
    ...
    'without-legend'?: LyraHeatmap['withoutLegend'];
  }
>;
...
export type LyraHtmlViewerReactProps = LyraReactElementProps<
  LyraHtmlViewer,
  | 'activeHighlightId'
  | 'anchor'
  | 'highlights'
...
export type LyraIconReactProps = LyraReactElementProps<
  LyraIcon,
  | 'animation'
  | 'autoWidth'
  | 'canvas'
...
export type LyraIconButtonReactProps = LyraReactElementProps<
  LyraIconButton,
  | 'accessibleLabel'
  | 'disabled'
  | 'download'
...
export type LyraImageComparerReactProps = LyraReactElementProps<
  LyraImageComparer,
  | 'accessibleLabel'
  | 'afterLabel'
  | 'beforeLabel'
...
export type LyraImageViewerReactProps = LyraReactElementProps<
  LyraImageViewer,
  | 'activeHighlightId'
  | 'alt'
  | 'anchor'
...
export type LyraIncludeReactProps = LyraReactElementProps<
  LyraInclude,
  | 'activeHighlightId'
  | 'anchor'
  | 'cache'
...
export type LyraIngestionQueueReactProps = LyraReactElementProps<
  LyraIngestionQueue,
  | 'announce'
  | 'items'
  | 'label'
...
export type LyraInputReactProps = LyraReactElementProps<
  LyraInput,
  | 'accessibleLabel'
  | 'appearance'
  | 'autocapitalize'
...
export type LyraIntersectionObserverReactProps = LyraReactElementProps<
...
export type LyraJsonSchemaViewerReactProps = LyraReactElementProps<
...
export type LyraJsonViewerReactProps = LyraReactElementProps<
  LyraJsonViewer,
  | 'collapsedDepth'
  | 'copyable'
  | 'data'
...
export type LyraKbdReactProps = LyraReactElementProps<
  LyraKbd,
  | 'keys'
  | 'locale'
  | 'platform'
...
export type LyraKnowledgeBaseReactProps = LyraReactElementProps<
  LyraKnowledgeBase,
  | 'error'
  | 'errorDescription'
  | 'errorHeading'
...
export type LyraKnowledgeBaseAdminReactProps = LyraReactElementProps<
...
export type LyraKnownDateReactProps = LyraReactElementProps<
  LyraKnownDate,
  | 'accessibleLabel'
  | 'appearance'
  | 'autocomplete'
...
export type LyraLiteChartReactProps = LyraReactElementProps<
  LyraLiteChart,
  | 'accessibleLabel'
  | 'axisLabelText'
  | 'barGapRatio'
...
export type LyraLiveRegionReactProps = LyraReactElementProps<
  LyraLiveRegion,
  | 'locale'
  | 'mode'
  | 'strings'
...
export type LyraLocalePickerReactProps = LyraReactElementProps<
  LyraLocalePicker,
  | 'customError'
  | 'defaultValue'
  | 'disabled'
  ...
  | '--lr-locale-picker-trigger-border-color'
  | '--lr-locale-picker-trigger-fill'
...
export type LyraMapReactProps = LyraReactElementProps<
  LyraMap,
  | 'center'
  | 'choropleth'
  | 'dataLayers'
...
export type LyraMarkdownReactProps = LyraReactElementProps<
  ...
  | '--lr-markdown-code-header-bg'
  | '--lr-markdown-code-header-color'
...
export type LyraMarkdownCoreReactProps = LyraReactElementProps<
  LyraMarkdownCore,
  | 'activeHighlightId'
  | 'anchor'
  | 'codeBlockChrome'
...
export type LyraMcpAppReactProps = LyraReactElementProps<
  LyraMcpApp,
  | 'accessibleLabel'
  | 'height'
  | 'label'
...
export type LyraMediaCardReactProps = LyraReactElementProps<
  LyraMediaCard,
  | 'accessibleLabel'
  | 'alt'
  | 'disabled'
...
export type LyraMemoryPanelReactProps = LyraReactElementProps<
  LyraMemoryPanel,
  | 'label'
  | 'locale'
  | 'longTerm'
...
export type LyraMentionPopoverReactProps = LyraReactElementProps<
  LyraMentionPopover,
  | 'anchor'
  | 'emptyText'
  | 'filter'
  ...
  | '--lr-mention-popover-option-active-color'
  | '--lr-mention-popover-option-disabled-opacity'
  | '--lr-overlay-border'
  | '--lr-overlay-radius'
  | '--lr-overlay-shadow-anchored'
  | '--lr-overlay-surface'
...
export type LyraMenuReactProps = LyraReactElementProps<
  LyraMenu,
  | 'dropdownOpen'
  | 'label'
  | 'locale'
...
export type LyraMenuItemReactProps = LyraReactElementProps<
  LyraMenuItem,
  | 'checked'
  | 'disabled'
  | 'download'
...
export type LyraMenuLabelReactProps = LyraReactElementProps<
  LyraMenuLabel,
  | 'locale'
  | 'role'
  | 'strings',
...
export type LyraMenubarReactProps = LyraReactElementProps<
  LyraMenubar,
  | 'frame'
  | 'label'
  | 'locale'
...
export type LyraMenubarItemReactProps = LyraReactElementProps<
  LyraMenubarItem,
  | 'disabled'
  | 'locale'
  | 'strings',
  ...
  {},
never,
  | '--lr-menubar-item-active-bg'
  | '--lr-menubar-item-hover-bg',
  {}
>;

export type LyraMessageActionsReactProps = LyraReactElementProps<
  LyraMessageActions,
  | 'accessibleLabel'
  | 'controls'
  | 'copyText'
...
export type LyraMindMapReactProps = LyraReactElementProps<
  LyraMindMap,
  | 'expandDepth'
  | 'label'
  | 'locale'
...
export type LyraModelSelectReactProps = LyraReactElementProps<
  LyraModelSelect,
  | 'allowCustom'
  | 'autocapitalize'
  | 'autocomplete'
  ...
  | '--lr-model-select-gap'
  | '--lr-model-select-max-inline-size'
  | '--lr-model-select-open-border-color'
  | '--lr-model-select-option-active-bg'
  | '--lr-model-select-option-disabled-opacity'
...
export type LyraModelSettingsPanelReactProps = LyraReactElementProps<
  ...
  | 'lr-change',
  | '--lr-model-settings-panel-max-inline-size',
  {
...
export type LyraMultiSplitReactProps = LyraReactElementProps<
  LyraMultiSplit,
  | 'collapse'
  ...
  | '--lr-multi-split-floating-panel-inset'
  | '--lr-multi-split-overlay-color',
  {
    ...
    'release-pin-on-breakpoint'?: LyraMultiSplit['releasePinOnBreakpoint'];
    'storage-key'?: LyraMultiSplit['storageKey'];
  }
>;

export type LyraMutationObserverReactProps = LyraReactElementProps<
...
export type LyraNativeTimeInputReactProps = LyraReactElementProps<
  LyraNativeTimeInput,
  | 'accessibleLabel'
  | 'appearance'
  | 'autocapitalize'
...
export type LyraNavigationMenuReactProps = LyraReactElementProps<
  LyraNavigationMenu,
  | 'accessibleLabel'
  | 'distance'
  | 'expanded'
  ...
  | '--lr-navigation-menu-toggle-active-color'
  | '--lr-positioning-strategy',
  {
...
export type LyraNavigationMenuItemReactProps = LyraReactElementProps<
  ...
  | '--lr-navigation-menu-item-active-color'
...
export type LyraNeighborListReactProps = LyraReactElementProps<
  LyraNeighborList,
  | 'expandable'
  | 'groupByRelation'
  | 'label'
...
export type LyraNodePaletteReactProps = LyraReactElementProps<
  LyraNodePalette,
  | 'accessibleLabel'
  | 'items'
  | 'label'
  ...
  | '--lr-node-palette-search-radius',
  {
    'aria-label'?: LyraNodePalette['accessibleLabel'];
  }
>;

export type LyraNotebookViewerReactProps = LyraReactElementProps<
  LyraNotebookViewer,
  | 'activeHighlightId'
  | 'anchor'
  | 'highlights'
...
export type LyraNumberInputReactProps = LyraReactElementProps<
  LyraNumberInput,
  | 'accessibleLabel'
  | 'appearance'
  | 'autocapitalize'
...
export type LyraOtpInputReactProps = LyraReactElementProps<
  LyraOtpInput,
  | 'appearance'
  | 'autocomplete'
  | 'autofocus'
...
export type LyraPageReactProps = LyraReactElementProps<
  LyraPage,
...
export type LyraPageRailReactProps = LyraReactElementProps<
  LyraPageRail,
  | 'for'
  | 'highlights'
  | 'label'
...
export type LyraPaginationReactProps = LyraReactElementProps<
  LyraPagination,
  | 'accessibleLabel'
  | 'appearance'
  | 'boundaryCount'
...
export type LyraPanZoomReactProps = LyraReactElementProps<
  LyraPanZoom,
  | 'accessibleLabel'
  | 'alt'
  | 'fit'
...
export type LyraPathStripReactProps = LyraReactElementProps<
  LyraPathStrip,
  | 'label'
  | 'locale'
  | 'path'
...
export type LyraPdfViewerReactProps = LyraReactElementProps<
  LyraPdfViewer,
  | 'activeHighlightId'
  | 'anchor'
  | 'highlights'
...
export type LyraPhoneInputReactProps = LyraReactElementProps<
  LyraPhoneInput,
  | 'accessibleLabel'
  | 'adapter'
  | 'autocapitalize'
...
export type LyraPolicySummaryReactProps = LyraReactElementProps<
  LyraPolicySummary,
  | 'decisions'
  | 'locale'
  | 'strings',
...
export type LyraPollStatusReactProps = LyraReactElementProps<
  LyraPollStatus,
  | 'active'
  | 'locale'
  | 'nextInMs'
...
export type LyraPopoverReactProps = LyraReactElementProps<
  LyraPopover,
  | 'accessibleLabel'
  | 'anchor'
  | 'arrow'
  ...
  | '--show-duration',
  {
    ...
    'hide-delay'?: LyraPopover['hideDelay'];
    'hover-bridge'?: LyraPopover['hoverBridge'];
...
export type LyraPopupReactProps = LyraReactElementProps<
  LyraPopup,
  | 'active'
  | 'anchor'
  | 'arrow'
...
export type LyraPptxViewerReactProps = LyraReactElementProps<
  LyraPptxViewer,
  | 'activeHighlightId'
  | 'anchor'
  | 'highlights'
...
export type LyraProgressRingReactProps = LyraReactElementProps<
  LyraProgressRing,
  | 'accessibleLabel'
  | 'indeterminate'
  | 'label'
...
export type LyraPromptInputReactProps = LyraReactElementProps<
  LyraPromptInput,
  | 'accessibleLabel'
...
export type LyraPromptQueueReactProps = LyraReactElementProps<
  LyraPromptQueue,
  | 'accessibleLabel'
  | 'disabled'
  | 'editable'
...
export type LyraPromptStudioReactProps = LyraReactElementProps<
  LyraPromptStudio,
  | 'autocapitalize'
  | 'autoCorrect'
  | 'disabled'
...
export type LyraProvenancePanelReactProps = LyraReactElementProps<
  LyraProvenancePanel,
  | 'label'
  | 'locale'
  | 'provenance'
...
export type LyraPushToTalkReactProps = LyraReactElementProps<
  LyraPushToTalk,
  | 'audioConstraints'
  | 'deviceId'
  | 'disabled'
...
export type LyraRadioReactProps = LyraReactElementProps<
  LyraRadio,
  | 'appearance'
  | 'checked'
  | 'customError'
...
export type LyraRadioButtonReactProps = LyraReactElementProps<
  LyraRadioButton,
  | 'appearance'
  | 'checked'
  | 'customError'
...
export type LyraRadioGroupReactProps = LyraReactElementProps<
  LyraRadioGroup,
  | 'accessibleLabel'
  | 'customError'
  | 'defaultValue'
...
export type LyraRagAnswerReactProps = LyraReactElementProps<
  LyraRagAnswer,
  | 'accessibleLabel'
  | 'announce'
  | 'answer'
...
export type LyraRagEvalDashboardReactProps = LyraReactElementProps<
...
export type LyraRandomContentReactProps = LyraReactElementProps<
  LyraRandomContent,
  | 'animation'
  | 'autoplay'
  | 'autoplayInterval'
...
export type LyraRatingReactProps = LyraReactElementProps<
  LyraRating,
  | 'accessibleLabel'
  | 'customError'
  | 'defaultValue'
...
export type LyraRealtimeSessionReactProps = LyraReactElementProps<
  LyraRealtimeSession,
  | 'entries'
  | 'label'
  | 'level'
...
export type LyraRelativeTimeReactProps = LyraReactElementProps<
  LyraRelativeTime,
  | 'date'
  | 'format'
  | 'locale'
...
export type LyraReorderItemReactProps = LyraReactElementProps<
  LyraReorderItem,
  | 'accessibleLabel'
  | 'disabled'
  | 'locale'
...
export type LyraReorderListReactProps = LyraReactElementProps<
  LyraReorderList,
  | 'controlled'
  | 'disabled'
  | 'label'
...
export type LyraResizeObserverReactProps = LyraReactElementProps<
  LyraResizeObserver,
  | 'box'
  | 'disabled'
  | 'locale'
...
export type LyraResponsivePanelReactProps = LyraReactElementProps<
  LyraResponsivePanel,
  | 'label'
  | 'locale'
  | 'mode'
...
export type LyraResultCardReactProps = LyraReactElementProps<
  LyraResultCard,
  | 'compact'
  | 'frame'
  | 'heading'
...
export type LyraResultFieldReactProps = LyraReactElementProps<
  LyraResultField,
  | 'label'
  | 'locale'
  | 'strings'
...
export type LyraRetrievalCompareReactProps = LyraReactElementProps<
...
export type LyraRetrievalResultsReactProps = LyraReactElementProps<
...
export type LyraRetrievalSearchReactProps = LyraReactElementProps<
  LyraRetrievalSearch,
  | 'accessibleLabel'
  | 'announce'
  | 'empty'
...
export type LyraRetrievalTraceReactProps = LyraReactElementProps<
  LyraRetrievalTrace,
  | 'activeStageId'
  | 'label'
  | 'locale'
...
export type LyraRubricFormReactProps = LyraReactElementProps<
  LyraRubricForm,
  | 'customError'
  | 'defaultValue'
  | 'disabled'
...
export type LyraScrollerReactProps = LyraReactElementProps<
  LyraScroller,
  | 'controls'
  | 'label'
  | 'locale'
...
export type LyraSegmentedReactProps = LyraReactElementProps<
  LyraSegmented,
  | 'items'
  | 'label'
  | 'locale'
...
export type LyraSelectReactProps = LyraReactElementProps<
  LyraSelect,
  | 'appearance'
  ...
  | '--lr-select-tag-remove-hover-bg'
  | '--lr-select-trigger-active-bg'
  | '--lr-select-trigger-border-color'
  | '--lr-select-trigger-fill'
...
export type LyraSelectionToolbarReactProps = LyraReactElementProps<
...
export type LyraSequencePlaybackReactProps = LyraReactElementProps<
...
export type LyraSequenceStripReactProps = LyraReactElementProps<
  LyraSequenceStrip,
  | 'accessibleLabel'
  | 'categories'
  | 'items'
  ...
  | 'lr-item-activate',
  | '--lr-sequence-strip-disabled-opacity'
...
export type LyraSkeletonReactProps = LyraReactElementProps<
  LyraSkeleton,
  | 'announce'
  | 'effect'
  | 'height'
...
export type LyraSliderReactProps = LyraReactElementProps<
  LyraSlider,
  | 'autofocus'
  | 'customError'
  | 'defaultValue'
...
export type LyraSourceCardReactProps = LyraReactElementProps<
  LyraSourceCard,
  | 'compact'
  | 'disabled'
  | 'frame'
...
export type LyraSourcePickerReactProps = LyraReactElementProps<
  LyraSourcePicker,
  | 'accessibleLabel'
  | 'label'
  | 'locale'
...
export type LyraSpanWaterfallReactProps = LyraReactElementProps<
  LyraSpanWaterfall,
  | 'activeSpanId'
  | 'hideAxis'
  | 'label'
...
export type LyraSparklineReactProps = LyraReactElementProps<
  LyraSparkline,
  | 'accessibleLabel'
  | 'appearance'
  | 'curve'
...
export type LyraSpinnerReactProps = LyraReactElementProps<
  LyraSpinner,
  | 'accessibleLabel'
  | 'labelPlacement'
  | 'locale'
...
export type LyraSplitPanelReactProps = LyraReactElementProps<
  LyraSplitPanel,
  | 'disabled'
  | 'locale'
  | 'orientation'
...
export type LyraStatReactProps = LyraReactElementProps<
  LyraStat,
  | 'accessibleLabel'
  | 'caption'
  | 'compact'
...
export type LyraStepperReactProps = LyraReactElementProps<
  LyraStepper,
  | 'accessibleLabel'
  | 'locale'
  | 'narrowOrientation'
...
export type LyraStreamStatusReactProps = LyraReactElementProps<
  LyraStreamStatus,
  | 'connectionState'
  | 'locale'
  | 'stallThresholdMs'
...
export type LyraSuggestionChipsReactProps = LyraReactElementProps<
  LyraSuggestionChips,
  | 'label'
  | 'locale'
  | 'strings'
  ...
  | '--lr-suggestion-chips-disabled-opacity'
...
export type LyraSvgViewerReactProps = LyraReactElementProps<
  LyraSvgViewer,
  | 'activeHighlightId'
  | 'anchor'
  | 'highlights'
...
export type LyraSwatchPickerReactProps = LyraReactElementProps<
  ...
  | '--lr-swatch-picker-wrap',
  {
    'aria-label'?: LyraSwatchPicker['accessibleLabel'];
  }
>;

export type LyraSwitchReactProps = LyraReactElementProps<
  LyraSwitch,
  | 'checked'
  | 'customError'
  | 'defaultChecked'
...
export type LyraTabReactProps = LyraReactElementProps<
  LyraTab,
  | 'active'
  | 'closable'
  | 'disabled'
...
export type LyraTabGroupReactProps = LyraReactElementProps<
  LyraTabGroup,
  | 'accessibleLabel'
  | 'activation'
  | 'active'
...
export type LyraTabPanelReactProps = LyraReactElementProps<
  LyraTabPanel,
  | 'active'
  | 'locale'
  | 'name'
...
export type LyraTableReactProps = LyraReactElementProps<
  LyraTable,
  | 'accessibleLabel'
  | 'announce'
  | 'autocapitalize'
...
export type LyraTagReactProps = LyraReactElementProps<
  LyraTag,
  | 'appearance'
  | 'attention'
  | 'locale'
...
export type LyraTerminalReactProps = LyraReactElementProps<
  LyraTerminal,
  | 'accessibleLabel'
  | 'activeHighlightId'
  | 'announceOutput'
...
export type LyraTestResultsReactProps = LyraReactElementProps<
  LyraTestResults,
  | 'autoExpandFailures'
  | 'locale'
  | 'runId'
...
export type LyraTextareaReactProps = LyraReactElementProps<
  LyraTextarea,
  | 'accessibleLabel'
  | 'appearance'
  | 'autocapitalize'
...
export type LyraThinkingPanelReactProps = LyraReactElementProps<
  LyraThinkingPanel,
  | 'compact'
  | 'durationMs'
  | 'expanded'
...
export type LyraThreadListReactProps = LyraReactElementProps<
  ...
  | '--lr-thread-list-search-clear-size'
  | '--lr-thread-list-search-font-size'
  | '--lr-thread-list-search-gap'
  | '--lr-thread-list-search-min-height'
  | '--lr-thread-list-search-padding'
...
export type LyraTimeInputReactProps = LyraReactElementProps<
  LyraTimeInput,
  | 'appearance'
  | 'autocomplete'
  | 'customError'
...
export type LyraTimeRangeReactProps = LyraReactElementProps<
  LyraTimeRange,
  | 'customError'
  | 'disabled'
  | 'end'
...
export type LyraTimelineReactProps = LyraReactElementProps<
  LyraTimeline,
  | 'accessibleLabel'
  | 'collision'
  | 'locale'
...
export type LyraTimelineItemReactProps = LyraReactElementProps<
  LyraTimelineItem,
  | 'active'
  | 'locale'
  | 'strings'
...
export type LyraToastReactProps = LyraReactElementProps<
  LyraToast,
  | 'locale'
  | 'placement'
  | 'strings',
...
export type LyraToastItemReactProps = LyraReactElementProps<
  LyraToastItem,
  | 'duration'
  | 'locale'
  | 'size'
...
export type LyraToggleReactProps = LyraReactElementProps<
  LyraToggle,
  | 'appearance'
  | 'disabled'
  | 'locale'
...
export type LyraToggleGroupReactProps = LyraReactElementProps<
  LyraToggleGroup,
  | 'appearance'
  | 'disabled'
  | 'label'
...
export type LyraTokenInputReactProps = LyraReactElementProps<
  LyraTokenInput,
  | 'accessibleLabel'
  | 'allowDuplicates'
  | 'autocapitalize'
...
export type LyraToolApprovalDialogReactProps = LyraReactElementProps<
...
export type LyraToolCallBlockReactProps = LyraReactElementProps<
  LyraToolCallBlock,
  | 'args'
  | 'callId'
  | 'durationMs'
...
export type LyraToolCallChipReactProps = LyraReactElementProps<
  LyraToolCallChip,
  | 'callId'
  | 'category'
  | 'durationMs'
...
export type LyraToolParamFormReactProps = LyraReactElementProps<
  LyraToolParamForm,
  | 'customError'
  | 'disabled'
  | 'form'
...
export type LyraToolResultDialogReactProps = LyraReactElementProps<
...
export type LyraToolResultViewReactProps = LyraReactElementProps<
  LyraToolResultView,
  | 'args'
  | 'copyable'
  | 'fallback'
...
export type LyraToolSelectDialogReactProps = LyraReactElementProps<
  ...
  | '--lr-tool-select-dialog-search-radius',
  {
...
export type LyraTooltipReactProps = LyraReactElementProps<
  LyraTooltip,
  | 'accessibleLabel'
  | 'anchor'
  | 'arrow'
...
export type LyraTourReactProps = LyraReactElementProps<
  LyraTour,
  | 'activeIndex'
  | 'distance'
  | 'lightDismiss'
...
export type LyraTraceTreeReactProps = LyraReactElementProps<
  LyraTraceTree,
  | 'activeSpanId'
  | 'hideBars'
  | 'label'
...
export type LyraTranscriptFeedReactProps = LyraReactElementProps<
  LyraTranscriptFeed,
  | 'accessibleLabel'
  | 'entries'
  | 'follow'
...
export type LyraTreeReactProps = LyraReactElementProps<
  LyraTree,
  | 'data'
  | 'label'
  | 'locale'
...
export type LyraTreeItemReactProps = LyraReactElementProps<
  LyraTreeItem,
  | 'disabled'
  | 'expanded'
  | 'item'
...
export type LyraTypingIndicatorReactProps = LyraReactElementProps<
  LyraTypingIndicator,
  | 'label'
  | 'labelPlacement'
  | 'locale'
...
export type LyraUsageBadgeReactProps = LyraReactElementProps<
  LyraUsageBadge,
  | 'abbreviate'
  | 'costText'
  | 'formatLatency'
...
export type LyraVideoReactProps = LyraReactElementProps<
  LyraVideo,
  | 'autoplay'
  | 'autoplayMuted'
  | 'autoplayOnVisible'
...
export type LyraVideoPlaylistReactProps = LyraReactElementProps<
  LyraVideoPlaylist,
  | 'autoAdvance'
  | 'controls'
  | 'iconLibrary'
...
export type LyraVirtualListReactProps = LyraReactElementProps<
  LyraVirtualList,
  | 'activeItemId'
  | 'groups'
  | 'hasMore'
...
export type LyraVisuallyHiddenReactProps = LyraReactElementProps<
  LyraVisuallyHidden,
  | 'locale'
  | 'strings',
  {},
...
export type LyraVoicePickerReactProps = LyraReactElementProps<
  LyraVoicePicker,
  | 'allowCustom'
  | 'autocapitalize'
  | 'autocomplete'
  ...
  | '--lr-voice-picker-option-disabled-opacity'
...
export type LyraWidgetReactProps = LyraReactElementProps<
  ...
  | '--lr-widget-collapse-button-hover-bg'
  | '--lr-widget-collapse-button-hover-color'
  | '--lr-widget-fullscreen-button-hover-bg'
  | '--lr-widget-fullscreen-button-hover-color'
...
export type LyraWidgetRendererReactProps = LyraReactElementProps<
  LyraWidgetRenderer,
  | 'bindingState'
  | 'document'
  | 'locale'
...
export type LyraXmlViewerReactProps = LyraReactElementProps<
  LyraXmlViewer,
  | 'activeHighlightId'
  | 'anchor'
  | 'collapsedDepth'
...
export type LyraZoomableFrameReactProps = LyraReactElementProps<
  LyraZoomableFrame,
  | 'accessibleLabel'
  | 'allowfullscreen'
  | 'loading'
