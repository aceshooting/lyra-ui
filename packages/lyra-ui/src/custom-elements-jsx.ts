...
import type { LyraNumberInput } from './components/forms/input/number-input.class.js';
import type { LyraTimeInput } from './components/forms/input/time-input.class.js';
...
import type { LyraDropdownItem } from './components/layout/menu/dropdown-item.class.js';
...
import type { LyraTab } from './components/layout/tab-group/tab.class.js';
...
import type { LyraToast } from './components/overlays/toast/toast.class.js';
...
export type LyraActivityFeedReactProps = LyraReactElementProps<
  ...
  | '--lr-activity-feed-max-height',
  {
    ...
    'virtualize-threshold'?: LyraActivityFeed['virtualizeThreshold'];
  }
>;
...
export type LyraComboboxReactProps = LyraReactElementProps<
  ...
  {
    'autocorrect'?: LyraCombobox['autoCorrect'];
...
export type LyraConfirmBarReactProps = LyraReactElementProps<
  ...
  | '--lr-confirm-bar-compact-background'
  | '--lr-confirm-bar-compact-border'
  | '--lr-confirm-bar-compact-gap'
  | '--lr-confirm-bar-compact-padding'
  | '--lr-confirm-bar-compact-radius'
...
export type LyraDocumentPreviewReactProps = LyraReactElementProps<
  ...
  | '--lr-document-preview-spin-duration',
  {
    ...
    'error-message'?: LyraDocumentPreview['errorMessage'];
...
export type LyraEvaluationRunReactProps = LyraReactElementProps<
  LyraEvaluationRun,
  | 'examples'
  | 'label'
  | 'locale'
...
export type LyraFlowCanvasReactProps = LyraReactElementProps<
  ...
  | '--lr-flow-canvas-node-current-outline-color'
...
export type LyraFlowRunOverlayReactProps = LyraReactElementProps<
  LyraFlowRunOverlay,
  | 'decorations'
  | 'for'
  | 'frame'
...
export type LyraGenerationStatusReactProps = LyraReactElementProps<
...
export type LyraIngestionQueueReactProps = LyraReactElementProps<
  ...
  {
    'virtualize-threshold'?: LyraIngestionQueue['virtualizeThreshold'];
  }
>;
...
export type LyraInputReactProps = LyraReactElementProps<
  ...
  | '--lr-input-radius',
  {
    ...
    'autocorrect'?: LyraInput['autoCorrect'];
...
export type LyraNumberInputReactProps = LyraReactElementProps<
  ...
  | '--lr-input-radius',
  {
    ...
    'autocorrect'?: LyraNumberInput['autoCorrect'];
...
export type LyraPlaybackReactProps = LyraReactElementProps<
  LyraPlayback,
  | 'hidden'
  | 'index'
  | 'intervalMs'
...
export type LyraQueryBuilderReactProps = LyraReactElementProps<
  LyraQueryBuilder,
  | 'disabled'
  | 'fields'
  | 'locale'
...
export type LyraRatingReactProps = LyraReactElementProps<
  ...
  | '--lr-rating-size',
  {
    'aria-label'?: LyraRating['accessibleLabel'];
  }
>;
...
export type LyraSchemaViewerReactProps = LyraReactElementProps<
  LyraSchemaViewer,
  | 'issues'
  | 'label'
  | 'locale'
...
export type LyraSplitReactProps = LyraReactElementProps<
  LyraSplit,
  | 'collapse'
...
export type LyraTextareaReactProps = LyraReactElementProps<
  ...
  | '--lr-textarea-radius',
  {
    ...
    'autocorrect'?: LyraTextarea['autoCorrect'];
...
export type LyraTimeInputReactProps = LyraReactElementProps<
  ...
  | '--lr-input-radius',
  {
    'aria-label'?: LyraTimeInput['accessibleLabel'];
    'autocorrect'?: LyraTimeInput['autoCorrect'];
    'enterkeyhint'?: LyraTimeInput['enterKeyHint'];
    'error-text'?: LyraTimeInput['errorText'];
    'inputmode'?: LyraTimeInput['inputMode'];
    'password-toggle'?: LyraTimeInput['passwordToggle'];
    'password-visible'?: LyraTimeInput['passwordVisible'];
    'with-clear'?: LyraTimeInput['withClear'];
    'without-spin-buttons'?: LyraTimeInput['withoutSpinButtons'];
  }
>;
...
export type LyraZoomableFrameReactProps = LyraReactElementProps<
  ...
  | 'lr-zoom-change',
  | '--lr-zoomable-frame-min-block-size'
  | '--lr-zoomable-frame-zoom',
  {
    'aria-label'?: LyraZoomableFrame['accessibleLabel'];
    'max-zoom'?: LyraZoomableFrame['maxZoom'];
    'min-zoom'?: LyraZoomableFrame['minZoom'];
    'zoom-step'?: LyraZoomableFrame['zoomStep'];
  }
>;
...
export interface LyraReactIntrinsicElements {
  ...
  'lr-evaluation-run': LyraEvaluationRunReactProps;
  ...
  'lr-flow-run-overlay': LyraFlowRunOverlayReactProps;
  ...
  'lr-generation-status': LyraGenerationStatusReactProps;
  ...
  'lr-playback': LyraPlaybackReactProps;
  ...
  'lr-query-builder': LyraQueryBuilderReactProps;
  ...
  'lr-schema-viewer': LyraSchemaViewerReactProps;
