...
export type LyraMessageKey =
  ...
  | 'sequenceStripBucketLabel'
  | 'sequenceStripBucketSummary'
  | 'noColumns'
  | 'dataGridColumnMenu'
  | 'dataGridPinStart'
  | 'dataGridPinEnd'
  ...
  | 'toolCallBlockHeaderPending'
  | 'toolCallBlockHeaderRunning'
  | 'toolCallBlockHeaderSuccess'
  | 'toolCallBlockHeaderError'
  | 'toolCallBlockHeaderDenied'
  | 'toolCallBlockArgumentsLabel'
  | 'toolCallBlockResultLabel'
  | 'toolCallBlockErrorLabel'
