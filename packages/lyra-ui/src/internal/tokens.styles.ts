...
export const tokens = css`
  :host {
    ...
    --lyra-line-height-tight: var(--lyra-theme-line-height-tight, 1.2);
    ...
    --lyra-line-height-relaxed: var(--lyra-theme-line-height-relaxed, 1.65);
    ...
    --lyra-size-0-8125rem: var(--lyra-theme-size-0-8125rem, 0.8125rem);
    --lyra-size-0-875em: var(--lyra-theme-size-0-875em, 0.875em);
    --lyra-size-0-875rem: var(--lyra-theme-size-0-875rem, 0.875rem);
    ...
    --lyra-size-1-125rem: var(--lyra-theme-size-1-125rem, 1.125rem);
    ...
    --lyra-size-11px: var(--lyra-theme-size-11px, 11px);
    ...
    --lyra-size-21px: var(--lyra-theme-size-21px, 21px);
    ...
    --lyra-size-639-98px: var(--lyra-theme-size-639-98px, 639.98px);
    ...
    --lyra-size-899-98px: var(--lyra-theme-size-899-98px, 899.98px);
    --lyra-size-8em: var(--lyra-theme-size-8em, 8em);
    --lyra-size-8rem: var(--lyra-theme-size-8rem, 8rem);
    --lyra-size-999px: var(--lyra-theme-size-999px, 999px);
