...
it('follows an explicit dark scope exactly as a component inside it does', async () => {
...
it('keeps the --lr-theme-* input layer as the override point for every curated colour', async () => {
  const scope = await fixture<HTMLElement>(html`
