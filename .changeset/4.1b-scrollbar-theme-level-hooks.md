...
who never sets the hook. New shared design tokens `--lr-scrollbar-width` and `--lr-scrollbar-gutter`
back the newly-covered scrollports and are published alongside the library's other design tokens.
