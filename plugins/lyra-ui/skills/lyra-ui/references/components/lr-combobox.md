...
- **Import** `import '@aceshooting/lyra-ui/components/lr-combobox.js';` (stable tag alias; registers the tag)
...
- **Deprecations** none
- **Optional peers** none
- **Themeable via** 33 parts, 30 custom properties — see this component's own `@csspart`/`@cssprop` list below
