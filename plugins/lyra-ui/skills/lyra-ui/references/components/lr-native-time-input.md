...
- **Import** `import '@aceshooting/lyra-ui/components/forms/input/native-time-input.js';` (registers the tag; side-effect import)
...
- **Deprecations** none
- **Optional peers** none
- **Themeable via** 18 parts, 9 custom properties — see this component's own `@csspart`/`@cssprop` list below
