...
- **Import** `import '@aceshooting/lyra-ui/components/lr-menubar.js';` (stable tag alias; registers the tag)
- **Class** `LyraMenubar`, also available unregistered from `@aceshooting/lyra-ui/components/layout/menubar/menubar.class.js`
...
- **Documented with** `lr-menubar-item` (same section below)
