...
- **Import** `import '@aceshooting/lyra-ui/components/data/tree/tree-item.js';` (registers the tag; side-effect import)
...
- **Deprecations** none
- **Optional peers** none
- **Themeable via** 28 parts, 15 custom properties — see this component's own `@csspart`/`@cssprop` list below
